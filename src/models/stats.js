...
module.exports.stakingPoolInfoModel = mongoose.model('staking_pool_stats', stakingPoolInfoModel)
module.exports.stakingPoolsInfoModel = mongoose.model('staking_pools_stats', stakingPoolsInfoModel)
